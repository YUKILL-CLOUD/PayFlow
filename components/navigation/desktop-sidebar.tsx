...
export function DesktopSidebar({ user, profile }: DesktopSidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'hidden md:flex flex-col h-full border-r border-border bg-sidebar transition-all duration-300 ease-in-out flex-shrink-0',
        isOpen ? 'w-60' : 'w-16'
      )}
